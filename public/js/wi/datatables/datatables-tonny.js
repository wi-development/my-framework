 ...
 *   https://datatables.net/download/#bs/dt-1.10.11,rr-1.1.1
 *
 * Included libraries:
 *   DataTables 1.10.11, RowReorder 1.1.1
 */
...
$.extend( RowReorder.prototype, {
	...
	_mouseDown: function ( e, target )
	{
		...
		if (that.c.disabled === true){
			console.info('_mouseDown that.c.disabled:'+that.c.disabled);
			return false;
		}
		var dt = this.s.dt;
		var start = this.s.start;
