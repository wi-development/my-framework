    ...
    module.directive('dropZone', function ($compile) {
        ...
        return {
            ...
            link: function (scope, element, attrs) {
                ...
                var previewTemplate = "<div id=\"\" class=\"file-row col-lg-3\"><div>"+
                    ...
                    "<div ng-click=\"addMediaTranslations(created_medium);\">add image</div>"+



                        //"<div ng-click=\"this.addImage(created_medium);\">this add image</div>"+
                    "<div>"+
