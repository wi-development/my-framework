		...
		legendCallback: function(chart) {
			...
			if (datasets.length) {
				for (var i = 0; i < datasets[0].data.length; ++i) {
					text.push('<li><span style="background-color:' + datasets[0].backgroundColor[i] + '"></span>XXX');
					if (labels[i]) {
						text.push(labels[i]);
					}
					text.push('</li>');
...
module.exports = function(Chart) {
	...
	Chart.defaults.polarArea = {
		...
		legendCallback: function(chart) {
			...
			if (datasets.length) {
				for (var i = 0; i < datasets[0].data.length; ++i) {
					text.push('<li><span style="background-color:' + datasets[0].backgroundColor[i] + '">xxx');
					if (labels[i]) {
						text.push(labels[i]);
					}
					text.push('</span></li>');
		...
		global: {
			...
			legendCallback: function(chart) {
				...
				for (var i = 0; i < chart.data.datasets.length; i++) {
					text.push('<li><span style="background-color:' + chart.data.datasets[i].backgroundColor + '"></span>jhgkjhg');
...
module.exports = function(Chart) {
	...
	Chart.Legend = Chart.Element.extend({
		...
		initialize: function(config) {
            //thisChart.legend.legendItems[0].text

            //console.info('INIT LEGEND');
...
//last dataset is for cross
                    //console.info(i+" "+legendItem.datasetIndex);
                    if (me.legendItems.length == (legendItem.datasetIndex+1)){
                        return true;
                    }
...
var test = false;
if (test){
//console.info(legendItem.datasetIndex);
...
//console.info((me.legendItems.length-2)+' == '+legendItem.datasetIndex);
//visual last (cross is last)
//if ((me.legendItems.length-2) == (legendItem.datasetIndex)){
//console.info(y);

if (typeof me.second == 'undefined'){
    me.second = false;
}
...
console.info(me.second);
if (me.second){
    me.y = (me.y + 10);
}

    if (typeof me.previewLastX == 'undefined'){
        me.previewLastX = 0;

        console.info(x+' - - '+me.previewLastX);
        if (x != me.previewLastX){
                //console.info(x+' - - '+me.previewLastX);
        }
    ...
    //console.info(Math.ceil(x)+' == '+Math.ceil(me.previewLastX));
...
module.exports = function(Chart) {
	...
	Chart.Tooltip = Chart.Element.extend({
		...
		getTitle: function() {
			...
			//var callbacks = opts.tooltips.callbacks;
