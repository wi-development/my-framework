...
//TODO
	...
	console.info(newChart.config.options.scales.xAxes);
	console.info(newChart.config.chartbackground.text.align);
	...
	console.warn(window.testx.config.options.scales.xAxes.ticks.max);
	console.warn(window.testx.config.chartbackground.text.align);
